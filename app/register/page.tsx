    ...
    <div className="min-h-screen flex items-center justify-center bg-black">
      <div className="w-full max-w-md p-8 rounded-2xl bg-zinc-900 border border-zinc-800">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white">Zivona</h1>
          <p className="text-zinc-400 mt-1">Create. Connect. Grow.</p>
        </div>
        ...
        <button
          ...
          className="w-full py-3 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white font-semibold border border-zinc-700 transition flex items-center justify-center gap-3"
        >
